function helperFuseFullLidarCamera(imageFileNames, ptCloudFileNames, intrinsic, tform)
...
for i = 1:numFrames
    ...
    %logFusioFileName = strrep(imageFileNames{i},'RawImages','FusionLogs');
    %print(logFusioFileName,'-dpng')
