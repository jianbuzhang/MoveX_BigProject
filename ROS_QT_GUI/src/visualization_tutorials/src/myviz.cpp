  ...
  : QWidget( parent )
{
  ...
  //TODO:jinjian
  QTextEdit* topicTextEdit = new QTextEdit("topic:jinjian");
  topicTextEdit->setFixedHeight(30);
  controls_layout->addWidget( topicTextEdit, 2, 0 );

  //TODO:jinjian
  QTabWidget* tab01 = new QTabWidget();
  QWidget* tab01_sonWidget01 = new QWidget();
  QWidget* tab01_sonWidget02 = new QWidget();
  tab01->setFixedHeight(150);
  tab01->addTab(tab01_sonWidget01,"sonWidget01");
  tab01->addTab(tab01_sonWidget02,"sonWidget02");
